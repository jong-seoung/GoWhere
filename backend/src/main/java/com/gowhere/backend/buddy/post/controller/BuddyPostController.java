package com.gowhere.backend.buddy.post.controller;

import com.gowhere.backend.buddy.post.dto.request.BuddyPostCreateRequest;
import com.gowhere.backend.buddy.post.dto.response.BuddyPostResponse;
import com.gowhere.backend.entity.BuddyPost;
import com.gowhere.backend.user.entity.User;
import com.gowhere.backend.buddy.post.service.BuddyPostService;
